...
export default function About() {
  return (
    <Box p={8}>
      ...
      <Flex justifyContent='center' alignItems='center' mb={4}></Flex>
      <Text fontSize='xl' textAlign='center' mb={8}>
        ...
        Whether you're a seasoned chef or a kitchen newbie, everyone has a story
        to share, and we're here to amplify those voices. Our journey began with
        a simple idea: to create a space where home cooks from all walks of life
        could come together to celebrate their love for cooking, share cherished
        family recipes, and discover new culinary adventures.
      </Text>
      ...
      <Text fontSize='xl' mt={8}>
        Whether you're a seasoned chef, an adventurous amateur, or just someone
        who loves good food, there's a place for you here at Tasty Recipe Talk.
        Our journey began with a simple idea: to create a space where home cooks
        from all walks of life could come together to celebrate their love for
        cooking, share cherished family recipes, and discover new culinary
        adventures.
      </Text>
      <Text fontSize='lg' mt={4}>
        We believe in the power of food to bring people together, and that's why
        we've built a platform that's more than just a recipe-sharing
      ...
      <Text fontSize='lg' mt={4}>
        ...
        growing community today and let's embark on a culinary journey together!
      </Text>
    </Box>
  );
}
