...
import { blockAccount, getUserByHandle,getUsersByEmail, getUsersByName, unblockAccount } from "../services/users.service";
...
export default function Admin() {
  ...
  return (
    <div>
      ...
      <p>Last Name: {userData.lastName}</p><br />
        {users.map((user) => (
          <div key={user.uid}>
            <h1>Results :</h1>
            ...
            {user.isBlocked ? (
            <Button onClick={() => unblockAcc(user.handle)}>Unblock user</Button>
          ) : (
